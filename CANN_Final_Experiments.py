...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 20 18:11:51 2024
...
experiments.loc[128] = [5, 20, 18, 10, 703, 8542, 3]
experiments.loc[129] = [5, 20, 18, 10, 703, 8542, 3]
experiments.loc[130] = [5, 20, 18, 10, 703, 8542, 3]
experiments.loc[131] = [5, 20, 18, 10, 703, 8542, 3]


# Calculate m and s values
m_values = [(max(s) + min(s)) / 2 for s in [set1, set2, set3, set4, set5, set6, set7]]
s_values = [(max(s) - min(s)) / 2 for s in [set1, set2, set3, set4, set5, set6, set7]]
...
#experiments.at[132, 'Optimizer'] = 6
#experiments.at[132, 'Optimizer'] = 8%7
...
for i in range(142):
    ...
    if experiments.iloc[i, 6] == 2:
        ...
        print("K=3 Layer")
    elif experiments.iloc[i, 6] == 0:
        print('No Layer')
    elif experiments.iloc[i, 6] == 6:
        Network = Dense(units=q1, activation='tanh', name='hidden1')(Network)
        Network = Dense(units=q2, activation='tanh', name='hidden2')(Network)
        Network = Dense(units=q3, activation='tanh', name='hidden3')(Network)
...
experiments.to_csv('Final_Experiments8is1.csv', index=False)
